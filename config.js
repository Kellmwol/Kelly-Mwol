...
module.exports = {
    ...
    SESSION: process.env.KELLY_CODE === undefined ? '' : process.env.AMALSER_CODE,
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'Shefin' : process.env.DEPLOYER,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'ShefinSir' : process.env.LOGO_NAME,
    MENTION: process.env.TAG_REPLY === undefined ? '919567489404@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    KELLY_MWOL: process.env.KELLY_MWOL === undefined ? 'Hello' : process.env.KELLY_MWOL,
    KELLY_MOL: process.env.KELLY_MOL === undefined ? 'Hii' : process.env.KELLY_MOL,   
